(() => {
    ...
    function Autoplay(_ref) {
        ...
        function onTransitionEnd(e) {
            ...
            swiper.autoplay.paused = false;
            if (!swiper.autoplay.running) stop(); else if (swiper.params.autoplay.delay === 0 && swiper.animating) swiper.once("transitionEnd", (() => {
                run();
            })); else run();
        }
    ...
    function initSliders() {
        if (document.querySelector(".progect-swiper")) new core(".progect-swiper", {
        ...
        if (document.querySelector(".swiper__product-categories")) new core(".swiper__product-categories", {
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        var eventCalllback = function(e) {
            var el = e.target, clearVal = el.dataset.phoneClear, pattern = el.dataset.phonePattern, matrix_def = "+375(__) ___-__-__", matrix = pattern ? pattern : matrix_def, i = 0, def = matrix.replace(/\D/g, ""), val = e.target.value.replace(/\D/g, "");
